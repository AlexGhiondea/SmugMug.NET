...
namespace SmugMug.v2.Types
{
    public partial class ImageSizesEntity : SmugMugEntity
    {
        ...
        private async Task<ImageSizeEntity> image____sizelarge (string param1)
        {
            // /image/(*)!sizelarge 
        ...
        private async Task<ImageSizeEntity> image____sizemedium (string param1)
        {
            // /image/(*)!sizemedium 
        ...
        private async Task<ImageSizeEntity> image____sizesmall (string param1)
        {
            // /image/(*)!sizesmall 
        ...
        private async Task<ImageSizeEntity> image____sizethumb (string param1)
        {
            // /image/(*)!sizethumb 
        ...
        private async Task<ImageSizeEntity> image____sizetiny (string param1)
        {
            // /image/(*)!sizetiny 
        ...
        private async Task<ImageSizeEntity> image____sizex2large (string param1)
        {
            // /image/(*)!sizex2large 
        ...
        private async Task<ImageSizeEntity> video____size110 (string param1)
        {
            // /video/(*)!size110 
        ...
        private async Task<ImageSizeEntity> video____size1280 (string param1)
        {
            // /video/(*)!size1280 
        ...
        private async Task<ImageSizeEntity> video____size200 (string param1)
        {
            // /video/(*)!size200 
        ...
        private async Task<ImageSizeEntity> video____size320 (string param1)
        {
            // /video/(*)!size320 
        ...
        private async Task<ImageSizeEntity> video____size640 (string param1)
        {
            // /video/(*)!size640 
        ...
        private async Task<ImageSizeEntity> video____size960 (string param1)
        {
            // /video/(*)!size960 
        ...
        private async Task<ImageSizeEntity> video____smil (string param1)
        {
            // /video/(*)!smil 
